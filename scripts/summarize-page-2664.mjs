...
const src = path.join(__dirname, '.migration-cache', 'page-2664.json');
const out = path.join(__dirname, '.migration-cache', 'page-2664-summary.json');
...
for (const r of records) {
  componentJs = componentJs ?? r.COMPONENT_JS;
